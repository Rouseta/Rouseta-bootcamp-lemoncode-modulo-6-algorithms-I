...
let finalPriceWithIva = document.getElementById('total');
...
//TODO Jose Antonio para revisar el bucle for of
...
const calculateTotalPrice = () => {
    ...
    return (subtotal.innerHTML = `${totalPrice}`);
};
const calculateIVA = () => {
    ...
    return (withIva.innerHTML = `${totalIVA}`);
};

const calculateFinalPrice = () => {
    let finalPrice = totalPrice + totalIVA;
    return (finalPriceWithIva.innerHTML = `${finalPrice} euros`);
}
